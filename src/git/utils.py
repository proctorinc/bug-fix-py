...
def filter_branches(remote_refs:IterableList) -> list[str]:
    """
...
def retrieve_branches(repository: Repo) -> list[str]:
    """
...
def check_is_full_app(branches: list[str]) -> bool:
    """
...
def cherrypick(repository_dir: str, branches: list[str], commit_id: str) -> None:
...
def get_minified_secure_branch(branches: list[str]) -> list[str]:
    """
